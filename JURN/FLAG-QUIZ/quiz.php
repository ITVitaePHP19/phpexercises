...
{ 
    case 1:
        $picture="http://localhost/ITVITAE/QUIZ/FLAGS/Belgium.png"; 
        $option1="Belgium"; 
        $option2="France"; 
        $option3="Germany"; 
        $option4="Holland"; 
        break; 
    case 2:
        $picture="http://localhost/ITVITAE/QUIZ/FLAGS/Korea-South.png"; 
        $option1="South-Korea"; 
        $option2="Japan"; 
        $option3="Thailand"; 
        $option4="Taiwan"; 
        ...
        break; 
    case 3: 
        $picture="http://localhost/ITVITAE/QUIZ/FLAGS/Italy.png"; 
        $option1="France"; 
        $option2="Germany"; 
        $option3="Sweden"; 
        $option4="Italy"; 
