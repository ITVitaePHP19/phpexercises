<?php
	...
	function roll()
	{
		...
		if(isset($_POST["hold"]))
		{
			...
			foreach ($hold as $die)
			{
				...
				switch($die)
				{
					case 0:
						$newroll .= $roll[0];
						echo "<td><img height='75' width='75' src='die" . $roll[0]  . ".png'></td>";
						break;
					case 1:
						$newroll .= $roll[1];
						echo "<td><img height='75' width='75' src='die" . $roll[1]  . ".png'></td>";
						break;
					case 2:
						$newroll .= $roll[2];
						echo "<td><img height='75' width='75' src='die" . $roll[2]  . ".png'></td>";
						break;
					case 3:
						$newroll .= $roll[3];
						echo "<td><img height='75' width='75' src='die" . $roll[3]  . ".png'></td>";
						break;
					case 4:
						$newroll .= $roll[4];
						echo "<td><img height='75' width='75' src='die" . $roll[4]  . ".png'></td>";
						break;
				}
			}
		}
		...
		{
			$throw = rand(1, 6);
			echo "<td><img height='75' width='75' src='die" . $throw  . ".png'></td>";
			$_SESSION["roll"] .= $throw;
		}		
